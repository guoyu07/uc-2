 ...
 */
class TeachersController extends \app\modules\admin\controllers\base\BaseAdminController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionFileDelete()
    {
        if(Yii::$app->request->post()) {
            //var_dump(Yii::$app->request->post('key'), $_POST);
            $file = Yii::$app->request->post('key');
            if(file_exists($file)) {
                unlink($file);
                return ["success" => Yii::$app->request->post('key')];
            }
        }

        return [ "error" => "Какая-то странная ошибка" ];
    }
